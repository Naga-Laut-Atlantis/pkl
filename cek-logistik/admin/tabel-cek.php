...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <form action="tabel-cek.php" method="POST" class="form-horizontal form-material">
                    ...
                    <table class="table user-table" id="tabel-print" style="table-layout: auto;">
                        ...
                        <?php
                            if (isset($tanggal_awal)) {
                                $query = " SELECT * FROM cek JOIN barang ON cek.kode_brg=barang.kode_brg WHERE tgl_cek BETWEEN '".$tanggal_awal."' AND '".$tanggal_akhir."' ORDER BY tgl_cek DESC ";
                            } else {
                                $query = " SELECT * FROM cek JOIN barang ON cek.kode_brg=barang.kode_brg WHERE tgl_cek BETWEEN '".$bulanLalu."' AND '".$tglSekarang."' ORDER BY tgl_cek DESC ";
                            }
