                ...
                <form action="" method="POST" class="form-horizontal form-material">
                    <div class="form-row pb-2">
                        ...
                        <div class="col-md-3 my-auto">
                            <a href="add-barang.php" type="button" class="btn btn-primary float-right d-inline-block float-right" style="font-size: 130%;"><i class="fas fa-plus"></i>&nbsp;Cek Peralatan</a>
                        </div>
                    </div>
                </form>
            </div>
